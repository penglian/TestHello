    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.insertsingle:  //插入单个的
                ...
                Fruit fruit = mFruitDaoUtil.queryFruitById(1L);
                tvResult.setText(fruit.getId()  + ":" + fruit.getCount() + ":" + fruit.getName());
                break;
            ...
            case R.id.refresh:  //刷新单个的
                ...
                fruit = mFruitDaoUtil.queryFruitById(1L);
                tvResult.setText(fruit.getId()  + ":" + fruit.getCount() + ":" + fruit.getName());
                break;
